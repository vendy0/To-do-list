...
function disableCheckboxes(disable) {
	let checkboxes = unorderedList.querySelectorAll("li input[type='checkbox']")
	let placeholderElement = document.getElementById("placeholder")

	checkboxes.forEach((checkbox) => {
		// Toujours désactiver le placeholder
		if (placeholderElement && placeholderElement.contains(checkbox)) {
			checkbox.disabled = true
		} else {
